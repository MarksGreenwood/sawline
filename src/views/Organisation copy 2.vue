    ...
    methods: {
        ...
        saveOrganisation(){
            ...
            if(this.form.status=='Edit')
            {
                ...
                //Reload the organisation
                this.get_organisationListing(this.organisationListing.current_page)
            ...
            try {
                await axios.post("/auth/organisations/create/sawline", {     
                    ...
                    .then((response) => { 
                        ...
                        if(this.isEmpty(response.data.errors===false))
                        {
                            alert(this.isEmpty(!response.data.errors));
        ...
        async generateKey() {
            try {
                await axios.post("/auth/organisations/generateKey/sawline", {       
