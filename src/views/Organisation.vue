                                                ...
                                                <div class="tab-content" id="v-pills-tabContent">
                                                    ...
                                                    <div class="tab-pane fade show active" id="v-pills-details" role="tabpanel">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.name" type="text" name="name" placeholder="" autocomplete="name" class="form-control">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.alias" type="text" name="alias" placeholder="" class="form-control">
                                                        </div>
                                                        <hr/>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.phone_1" type="text" name="phone_1" placeholder="" class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.phone_2" type="text" name="phone_2" placeholder="" class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.phone_3" type="text" name="phone_3" placeholder="" class="form-control">
                                                        </div>                                                        
                                                        <hr/>
                                                        <!-- Organisation email -->
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.email" type="text" name="email" placeholder="" class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.web" type="text" name="web" placeholder="" class="form-control">
                                                        </div>
                                                    </div>
                                                    <!-- /Organisation details page -->
                                                    ...
                                                    <div class="tab-pane fade show" id="v-pills-logo" role="tabpanel">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <div class="custom-file">
                                                                <input @change="uploadLogo" type="file" name="iconFile" id="iconFile" class="custom-file-input">
                                                                ...
                                                                <div class="tab-content" id="v-pills-tabContacts_Content">
                                                                    ...
                                                                    <div class="tab-pane fade show active" id="v-pills-contact1" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactDescr_1" type="text" name="contactDescr_1" id="inputContactDescr_1" placeholder="" class="form-control" @change="contactDescription()">
                                                                        </div>
                                                                        <!-- Contact name -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactName_1" type="text" name="contactName_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact phone -->
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactPhone_1" type="text" name="contactPhone_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact mobile -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactMobile_1" type="text" name="contactMobile_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact fax -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactFax_1" type="text" name="contactFax_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact email -->
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input v-model="form.contactEmail_1" type="text" name="contactEmail_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact web -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactWeb_1" type="text" name="contactWeb_1" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- Contacts 1 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-contact2" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactDescr_2" type="text" name="contactDescr_2" id="inputContactDescr_2" placeholder="" class="form-control" @change="contactDescription()">
                                                                        </div>
                                                                        <!-- Contact name -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactName_2" type="text" name="contactName_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact phone -->
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactPhone_2" type="text" name="contactPhone_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact mobile -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactMobile_2" type="text" name="contactMobile_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact fax -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactFax_2" type="text" name="contactFax_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact email -->
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input v-model="form.contactEmail_2" type="text" name="contactEmail_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact web -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactWeb_2" type="text" name="contactWeb_2" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Contacts 2 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-contact3" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactDescr_3" type="text" name="contactDescr_3" id="inputContactDescr_3" placeholder="" class="form-control" @change="contactDescription()">
                                                                        </div>
                                                                        <!-- Contact name -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactName_3" type="text" name="contactName_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact phone -->
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactPhone_3" type="text" name="contactPhone_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact mobile -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactMobile_3" type="text" name="contactMobile_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact fax -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactFax_3" type="text" name="contactFax_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact email -->
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input v-model="form.contactEmail_3" type="text" name="contactEmail_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact web -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactWeb_3" type="text" name="contactWeb_3" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Contacts 3 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-contact4" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactDescr_4" type="text" name="contactDescr_4" id="inputContactDescr_4" placeholder="" class="form-control" @change="contactDescription()">
                                                                        </div>
                                                                        <!-- Contact name -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactName_4" type="text" name="contactName_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact phone -->
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactPhone_4" type="text" name="contactPhone_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact mobile -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactMobile_4" type="text" name="contactMobile_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact fax -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactFax_4" type="text" name="contactFax_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact email -->
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input v-model="form.contactEmail_4" type="text" name="contactEmail_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact web -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactWeb_4" type="text" name="contactWeb_4" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- Contacts 4 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-contact5" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactDescr_5" type="text" name="contactDescr_5" id="inputContactDescr_5" placeholder="" class="form-control" @change="contactDescription()">
                                                                        </div>
                                                                        <!-- Contact name -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactName_5" type="text" name="contactName_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact phone -->
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.contactPhone_5" type="text" name="contactPhone_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact mobile -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactMobile_5" type="text" name="contactMobile_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact fax -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactFax_5" type="text" name="contactFax_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <hr/>
                                                                        <!-- Contact email -->
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input v-model="form.contactEmail_5" type="text" name="contactEmail_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Contact web -->
                                                                        <div class="input-group mb-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.contactWeb_5" type="text" name="contactWeb_5" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- Contacts 5 page -->                                                               
                                                                ...
                                                                <div class="tab-content" id="v-pills-tabAddresses_Content">
                                                                    ...
                                                                    <div class="tab-pane fade show active" id="v-pills-address1" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.addressDescr_1" type="text" name="addressDescr_1" id="inputAddressDescr_1" placeholder="" class="form-control" @change="addressDescription()">
                                                                        </div>
                                                                        <!-- Address line1 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address1_1" type="text" name="address1_1" id="inputAddress1_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address line2 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address2_1" type="text" name="address2_1" id="inputAddress2_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address city -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address3_1" type="text" name="address3_1" id="inputAddress3_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address state -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address4_1" type="text" name="address4_1" id="inputAddress4_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address postcode -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address5_1" type="text" name="address5_1" id="inputAddress5_1" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address country -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address6_1" type="text" name="address6_1" id="inputAddress6_1" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Address 1 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-address2" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.addressDescr_2" type="text" name="addressDescr_2" id="inputAddressDescr_2" placeholder="" class="form-control" @change="addressDescription()">
                                                                        </div>
                                                                        <!-- Address line1 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address1_2" type="text" name="address1_2" id="inputAddress1_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address line2 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address2_2" type="text" name="address2_2" id="inputAddress2_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address city -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address3_2" type="text" name="address3_2" id="inputAddress3_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address state -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address4_2" type="text" name="address4_2" id="inputAddress4_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address postcode -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address5_2" type="text" name="address5_2" id="inputAddress5_2" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address country -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address6_2" type="text" name="address6_2" id="inputAddress6_2" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Address 2 page -->    
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-address3" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.addressDescr_3" type="text" name="addressDescr_3" id="inputAddressDescr_3" placeholder="" class="form-control" @change="addressDescription()">
                                                                        </div>
                                                                        <!-- Address line1 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address1_3" type="text" name="address1_3" id="inputAddress1_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address line2 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address2_3" type="text" name="address2_3" id="inputAddress2_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address city -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address3_3" type="text" name="address3_3" id="inputAddress3_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address state -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address4_3" type="text" name="address4_3" id="inputAddress4_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address postcode -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address5_3" type="text" name="address5_3" id="inputAddress5_3" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address country -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address6_3" type="text" name="address6_3" id="inputAddress6_3" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>                                                            
                                                                    <!-- /Address 3 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-address4" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.addressDescr_4" type="text" name="addressDescr_4" id="inputAddressDescr_4" placeholder="" class="form-control" @change="addressDescription()">
                                                                        </div>
                                                                        <!-- Address line1 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address1_4" type="text" name="address1_4" id="inputAddress1_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address line2 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address2_4" type="text" name="address2_4" id="inputAddress2_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address city -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address3_4" type="text" name="address3_4" id="inputAddress3_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address state -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address4_4" type="text" name="address4_4" id="inputAddress4_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address postcode -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address5_4" type="text" name="address5_4" id="inputAddress5_4" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address country -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address6_4" type="text" name="address6_4" id="inputAddress6_4" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Address 4 page -->
                                                                    ...
                                                                    <div class="tab-pane fade" id="v-pills-address5" role="tabpanel">
                                                                        ...
                                                                        <div class="input-group my-3">
                                                                            ...
                                                                            <input v-model="form.addressDescr_5" type="text" name="addressDescr_5" id="inputAddressDescr_5" placeholder="" class="form-control" @change="addressDescription()">
                                                                        </div>
                                                                        <!-- Address line1 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address1_5" type="text" name="address1_5" id="inputAddress1_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address line2 -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address2_5" type="text" name="address2_5" id="inputAddress2_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address city -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address3_5" type="text" name="address3_5" id="inputAddress3_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address state -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address4_5" type="text" name="address4_5" id="inputAddress4_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address postcode -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address5_5" type="text" name="address5_5" id="inputAddress5_5" placeholder="" class="form-control">
                                                                        </div>
                                                                        <!-- Address country -->
                                                                        <div class="input-group my-3">
                                                                            <div class="input-group-prepend input-group-prepend-100">
                                                                            ...
                                                                            <input v-model="form.address6_5" type="text" name="address6_5" id="inputAddress6_5" placeholder="" class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    <!-- /Address 5 page -->
                                                    ...
                                                    <!-- Settings page -->
                                                     <div class="tab-pane fade show" id="v-pills-settings" role="tabpanel">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input v-model="form.key" type="text" name="key" id="key" disabled class="form-control">
                                                            <div class="input-group-append">
                                                                <button @click="getCompanyKey" type="button" class="btn btn-secondary"><i class="fas fa-plus-square"></i></button>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="input-group my-3">
                                                            ...
                                                            <input v-model="form.keyPrefix" type="text" name="keyPrefix" placeholder="" autocomplete="keyPrefix" class="form-control">
                                                            <input v-model="form.keySuffix" type="text" name="keySuffix" placeholder="" autocomplete="keySuffix" class="form-control">
                                                        </div>
                                                        <!-- Settings key length -->
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend input-group-prepend-100">
                                                            ...
                                                            <input v-model="form.keyLength" type="text" name="keyLength" placeholder="Key Length" autocomplete="keyLength" class="form-control">
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select v-model="form.keyLevel" id="keyLevel" name="keyLevel" placeholder="Security key level" autocomplete="keyLevel" class="form-control custom-select">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select v-model="form.owner_id" id="ownerID" name="owner_id" placeholder="" class="form-control custom-select">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select v-model="form.admin_id" id="adminID" name="admin_id" placeholder="" class="form-control custom-select">
                                                                <option v-for="adminUser in data_adminUsers" :key="adminUser.id" :value="adminUser.id">{{adminUser.name}}</option>
                                                            </select>
                                                        </div>
                                                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                ...
                id: 0,
                key: '', keyPrefix: '', keySuffix: '', keyLength: '10', keyLevel: '1',
    ...
    methods: {
        ...
        async get_organisationListing(page = 1){
            await axios.post("/auth/organisations/sawline?page=" + page)
            .then((response) => { 
                this.processResponse(true, response.data.errors, response.data.messages)
                ...
                nextTick(() => {   
                    if(Object.keys(this.errors).length ===0)
                    {
                        ...
                        // register errors
                        this.processMessages(this.errors, 'error')
                    }   
                });                
            })
            .catch(e => {
                // Error can not get organisations
                window.toast.fire({ icon: "error", title: e })
            });
        },
        async get_adminUsers(organisation, $showMessage=0){
            await axios.post("/auth/organisations/adminusers/sawline", {
            ...
            .then((response) => { 
                ...
                nextTick(() => {   
                    if(Object.keys(this.errors).length ===0)
                    {
                        // Display all messages
                        if($showMessage==1){
                            this.processMessages(this.messages, 'success')
                        }
                        this.data_adminUsers = response.data.organisationAdmin
                        return 'success'
                    }else{
                        // register errors
                        if($showMessage==1){                        
        ...
        getCompanyKey() {
            window.swal.fire({
                title: 'Are you sure ?',
                text: 'If you change the key other users may be disconected from this organisation.',
            ...
            .then((result) => {
                if (result.value) {
                        axios.post("/auth/organisations/generateKey/sawline", {       
                        keyPrefix: this.form.keyPrefix, 
                        keySuffix: this.form.keySuffix, 
                        keyLength: this.form.keyLength, 
                        keyLevel: this.form.keyLevel,
                    })
                    .then((response) => { 
        ...
        resetForm(formType) {
                this.form.status= formType;
                this.form.edited= false;
                this.form.id= 0;
                this.form.key= ''; this.form.keyPrefix= ''; this.form.keySuffix= ''; this.form.keyLength= '10', this.form.keyLevel= '1';
                this.form.name= ''; this.form.alias= ''; this.form.iconFile= ''; this.form.iconFile64= ''; this.form.preIconFile= '';
        ...
        updateFromForm(curentOrg) {
                ...
                curentOrg.key= this.form.key; curentOrg.keyPrefix= this.form.keyPrefix; curentOrg.keySuffix= this.form.keySuffix; curentOrg.keyLength= '5', curentOrg.keyLevel= '1';
        ...
        newOrganisation() { 
            ...
            axios.post("/auth/organisations/generateKey/sawline", { keyPrefix: this.form.keyPrefix, 
                                                                    keySuffix: this.form.keySuffix, 
                                                                    keyLength: this.form.keyLength, 
                                                                    keyLevel: this.form.keyLevel
                                                                  }).then((response) => { this.form.key = response.data.key; })
            var $user = this.user;
            this.data_adminUsers = JSON.parse('[{ "id":"'+ $user['id']+ '", "name":"'+ $user['name'] + '"}]');
        ...
        editOrganisation(organisation) {
            ...
            this.get_adminUsers(organisation, 0)
        ...
        saveOrganisation() {
            ...
            if(this.form.status=='New')
            {
                ...
                window.toast.fire({ icon: "success", title: 'The organisation has been created' })  
            }else{
                if(this.form.edited===true)
                {
                    ...
                    for (var i = 0; i < this.organisationListing.data.length; i++) 
                    {
                        if(this.organisationListing.data[i].id==this.form.id)
                        {
                            ...
                            this.updateOrganisation(curentOrg, 1)
            ...
            .then((response) => { 
                ...
                nextTick(() => {   
                    if(Object.keys(this.errors).length ===0)
                    {
                        ...
                        // register errors
                        this.processMessages(this.errors, 'error')
                        this.processErrors(response.data.errors, 'error')
                    }   
                }); 
            });
        },
        async updateOrganisation(organisation, $showMessage=0) {
        ...
        processResponse($clear, $errors, $messages) {
            ...
            if(Object.keys($errors).length!=0)
            {
                for (var eKey in $errors) {  
                    var $eKey = eKey;
                    var $eErrors = $errors[eKey];
                    this.errors[$eKey] = $eErrors;
                }
            }
            ...
            if(Object.keys($messages).length!=0)
            {
                for (var mKey in $messages) {  
                    var $mKey = mKey;
                    var $mMessages = $messages[mKey];
                    this.messages[$mKey] = $mMessages;
                }
            }
        },
        processMessages(object, type){
            ...
            for (var key in object) {       
                window.toast.fire({ icon: type, title: object[key] }); 
            }
        ...
        deactivateOrganisation(organisation) {
            ...
            // Set the currently active organisation to de activated
            this.setActiveOrganisation(0)

            nextTick(() => { 
                var $return = this.updateOrganisation(organisation, 0) 
                ...
                if($return!='fail')
                {
                    ...
                    window.toast.fire({ icon: "fail", title: organisation.name + ' could not be de-activated'})
                    this.$Progress.fail();
                }
            });
        },
        activateOrganisation(organisation) {
            ...
            nextTick(() => { 
                ...
                if($return!='fail')
                {
                    ...
                    window.toast.fire({ icon: "fail", title: organisation.name + ' could not be activated'})
                    this.$Progress.fail();
                }
            });
        },
